...
data=$HOME/storage/fiuba/tesis/dbase/latino40/preprocessed/latino40_asr/
data_partitions=$HOME/storage/fiuba/tesis/dbase/latino40/preprocessed/latino40_asr/shuffled/40_100
...
if [ $stage -le 1 ]; then
  ...
  for part in train val 'test'; do
    ...
    local/data_prep.pl $data $data_partitions $part data/$(echo $part | tr - _)
  done
